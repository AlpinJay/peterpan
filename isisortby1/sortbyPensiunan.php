...
<?php
include "../koneksi.php";
$query = mysqli_query($connection,"SELECT b.kerja as keterangan, count(a.no_daftar) as jumlah FROM calon a LEFT OUTER JOIN kerja b ON a.kerja_ortu = b.kerja where b.kerja = 'Pensiunan' GROUP by 1 ORDER by 1");
?>
